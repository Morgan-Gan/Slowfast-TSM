...
data_root = '/home/gan/data/video_caption_database/video_database/sthsthv2/sthsthv2_frame/'
data_root_val = '/home/gan/data/video_caption_database/video_database/sthsthv2/sthsthv2_frame/'
...
data = dict(
    ...
    workers_per_gpu=8,   # default 8
    train=dict(
        type=dataset_type,
        ann_file='/home/gan/home/ganhaiyang/Alg_Proj/Recog_Proj/TPN/data/sthv2/train_videofolder.txt',
        ...
        random_shift=True,
        modality='RGB',
        image_tmpl='{:06d}.jpg',                    # 'img_{:05d}.jpg'
        img_scale=256,
        input_size=224,
        flip_ratio=0.5,
    ...
    val=dict(
        type=dataset_type,
        ann_file='/home/gan/home/ganhaiyang/Alg_Proj/Recog_Proj/TPN/data/sthv2/val_videofolder.txt',
